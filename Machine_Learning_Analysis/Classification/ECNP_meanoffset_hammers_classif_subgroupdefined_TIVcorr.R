...
data_neuroimg_classif <- data_neuroimg %>% 
  select(c("SITE_ID","Diagnosis","HC_idx",starts_with("hammers")))
...
data_neuroimg_classif_verona <- data_neuroimg_verona %>% 
  select(c("SITE_ID","HC_idx","Diagnosis",starts_with("hammers")))
...
save(resampling_neuroimg,file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_MUC_OSL_VER.RData")
...
save(resampling_neuroimg_rest_munich_oslo,file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_MUC_OSL.RData")
...
save(resampling_neuroimg_rest_munich_verona,file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_MUC_VER.RData")
...
save(resampling_neuroimg_rest_oslo_verona,file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_OSL_VER.RData")
...
save(preds_verona, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_appliedonVerona.RData")
...
save(preds_oslo, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_appliedonOslo.RData")
...
save(preds_munich, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_appliedonMunich.RData")
...
save(preds_HC_int, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_appliedonHC_int.RData")
...
save(preds_HC_ext, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_hammers_globaloffset_appliedonHC_ext.RData")
