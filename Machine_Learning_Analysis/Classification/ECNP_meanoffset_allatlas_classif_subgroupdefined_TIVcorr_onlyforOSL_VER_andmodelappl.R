...
load("/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_schaefer200_gmv_globaloffset_MUC_OSL_VER.RData")


load("/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_schaefer200_gmv_globaloffset_MUC_OSL.RData")
