...
data_matched_topat <- data_matched_topat %>% 
  select(c("PID","SITE_ID", "AGE", "SEX","Diagnosis","TIV","QC_grade", starts_with("schaefer200"),starts_with("aal3"),starts_with("schaefer200"),starts_with("aal3"),starts_with("hammers")))
data_pat=data0 %>% 
  select(c("PID","SITE_ID", "AGE", "SEX","Diagnosis","TIV","QC_grade", starts_with("schaefer200"),starts_with("aal3"),starts_with("schaefer200"),starts_with("aal3"),starts_with("hammers")))
...
data_neuroimg_classif <- data_neuroimg %>% 
  select(c("SITE_ID","Diagnosis","HC_idx",starts_with("schaefer200"),starts_with("aal3"),starts_with("hammers")))
dim(data_neuroimg_classif)
...
data_neuroimg_classif_verona <- data_neuroimg_verona %>% 
  select(c("SITE_ID","HC_idx","Diagnosis",starts_with("schaefer200"),starts_with("aal3"),starts_with("hammers")))
...
save(resampling_neuroimg,file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_MUC_OSL_VER.RData")
...
save(resampling_neuroimg_rest_munich_oslo,file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_MUC_OSL.RData")
...
save(resampling_neuroimg_rest_munich_verona,file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_MUC_VER.RData")
...
save(resampling_neuroimg_rest_oslo_verona,file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_OSL_VER.RData")
...
save(preds_verona, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_appliedonVerona.RData")
...
save(preds_oslo, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_appliedonOslo.RData")
...
save(preds_munich, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_appliedonMunich.RData")
...
save(preds_HC_int, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_appliedonHC_int.RData")
...
save(preds_HC_ext, file = "/usr/local/vipar/projects/project_17/ECNP_classif_HCSCZ_allatlas_globaloffset_appliedonHC_ext.RData")
