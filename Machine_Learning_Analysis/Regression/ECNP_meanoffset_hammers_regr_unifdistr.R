...
data_neuroimg_regr <- data_neuroimg_hc %>% 
  select(c("PID","SITE_ID","HC_idx","AGE", starts_with("hammers_gmv")))
...
data_neuroimg_regr <- data_neuroimg_regr %>% 
  select(c("AGE","HC_idx","SITE_ID", starts_with("hammers_gmv")))
...
res<-res[[1]]
save(res,file = "/volume/mitnvp1_scratch/AK_Testing/ECNP/regression_age_allsites_hammers_gmv_meanoffset_UniDistr_normHC_withgroup_offset.RData")
...
save(predictions_patients_regr_rem, file = "/volume/mitnvp1_scratch/AK_Testing/ECNP/regression_age_hammers_gmv_meanoffset_UniDistr_appliedremHC_withgroup_offset.RData")

predictions_patients_scz <- predict(res$model, task = task_patients_scz_all)
predictions_patients_scz
save(predictions_patients_scz, file = "/volume/mitnvp1_scratch/AK_Testing/ECNP/regression_age_hammers_gmv_meanoffset_UniDistr_appliedsczall_withgroup_offset.RData")

predictions_patients_scz_MUC <- predict(res$model, task = task_patients_scz_MUC)
predictions_patients_scz_MUC
save(predictions_patients_scz_MUC, file = "/volume/mitnvp1_scratch/AK_Testing/ECNP/regression_age_hammers_gmv_meanoffset_UniDistr_appliedsczMUC_withgroup_offset.RData")

predictions_patients_scz_VER <- predict(res$model, task = task_patients_scz_VER)
predictions_patients_scz_VER
save(predictions_patients_scz_VER, file = "/volume/mitnvp1_scratch/AK_Testing/ECNP/regression_age_hammers_gmv_meanoffset_ICA_UniDistr_appliedsczVER_withgroup_offset.RData")

predictions_patients_scz_OSL <- predict(res$model, task = data_neuroimg_patients_scz_OSL)
predictions_patients_scz_OSL
save(predictions_patients_scz_OSL, file = "/volume/mitnvp1_scratch/AK_Testing/ECNP/regression_age_hammers_gmv_meanoffset_UniDistr_appliedsczOSL_withgroup_offset.RData")
